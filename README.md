...
# Motivation 
I have a folder in my PC that inside has files from my undergraduate cource, my projects and many more. This folder contains most of the stuff I need to work on a daily basis and I keep it organised to find everything easily. When I had only my PC that was easy since everything was in one place. But then I also got a laptop to be able to carry to the university, which meant that I had to move all the files from my PC to the laptop but most importantly keep it synchronised. 
...
*Afterwards I added a shortcut of the script to the shell:startup in my Windows partition and to the .bashrc file on my Linux so it automatically run on startup, so I had one less thing to do. 🫠*
...
### Download the script
**Linux:** Download **auto_git.sh** in your directory and run ```chmod +x auto_git.sh```. For easier use you can add auto_git.sh to your $PATH so you can call it directly from anywhere.

**MAC:** Download **auto_git.command** in your directory and run ```chmod +x auto_git.command```.

**Windows:** Download **auto_git.bat** in your folder. For easier use you can create a shortcut of the script and put it whenever you want (e.g. your Desktop).
<br>
<br>
